...
def trajectory_fans_figure(cfg: RegWorldConfig) -> Any | None:
...
def latent_pca_figure(cfg: RegWorldConfig) -> Any | None:
...
def network_diffusion_figure(cfg: RegWorldConfig) -> Any | None:
...
def make_all_interactive(cfg: RegWorldConfig) -> list[Path]:
