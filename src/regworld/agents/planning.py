"""Roll a :data:`~regworld.agents.registry.PolicyFn` in either world and
...
from regworld.agents.registry import PolicyFn
from regworld.environments.abm_env import AbmEnv, ModelFactory
