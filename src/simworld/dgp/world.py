...
from simworld.rules import Constants, FirmAttributes, SegmentAttributes, Theta
...
def generate_firms(cfg: SimWorldConfig, rng: np.random.Generator) -> FirmAttributes:
...
def generate_segments(
    cfg: SimWorldConfig, firms: FirmAttributes, rng: np.random.Generator
