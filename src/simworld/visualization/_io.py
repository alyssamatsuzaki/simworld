...
this module imports ``simworld.dgp`` or reads the sealed answer-key tree.
"""
...
def load_cube(cfg: SimWorldConfig) -> Any | None:
...
def eval_metrics(cfg: SimWorldConfig) -> dict[str, Any] | None:
