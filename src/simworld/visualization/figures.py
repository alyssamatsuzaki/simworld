...
Leakage firewall (PLAN.md §1): nothing here imports ``simworld.dgp`` or reads
...
``simworld.evaluation.parameter_recovery`` already computed and wrote to
...
from simworld.visualization._io import eval_metrics, load_cube, load_json

log = logging.getLogger(__name__)


def _fig_dir(cfg: SimWorldConfig) -> Path:
...
# --------------------------------------------------------------------- fig 1
def fig_four_numbers(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# --------------------------------------------------------------------- fig 2
def fig_parameter_recovery(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# --------------------------------------------------------------------- fig 3
def fig_arviz_diagnostics(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# --------------------------------------------------------------------- fig 4
def fig_event_study(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# --------------------------------------------------------------------- fig 5
def fig_emulator_error_vs_horizon(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# --------------------------------------------------------------------- fig 6
def fig_imagined_vs_real(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# --------------------------------------------------------------------- fig 7
def fig_calibration_curve(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
def fig_trajectory_fans(cfg: SimWorldConfig, fig_dir: Path, n_seeds: int = 12) -> Path | None:
    ...
    ``simworld.ensemble.cube`` uses per cell, just recording every quarter
...
# --------------------------------------------------------------------- fig 9
def fig_pareto_frontier(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# -------------------------------------------------------------------- fig 10
def fig_sensitivity_tornado(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# -------------------------------------------------------------------- fig 11
def fig_noncompliance_network(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# -------------------------------------------------------------------- fig 12
def fig_policy_comparison_j(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
# -------------------------------------------------------------------- fig 13
def fig_ood_degradation(cfg: SimWorldConfig, fig_dir: Path) -> Path | None:
...
def make_all_figures(cfg: SimWorldConfig) -> list[Path]:
