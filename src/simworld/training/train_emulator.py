...
from simworld.models.world_model import WorldModel, build_world_model
from simworld.training import datamodule
from simworld.training.checkpoint import checkpoint_path, save_checkpoint
...
def _constructor_kwargs(cfg: SimWorldConfig, arch: str, aggregate_dim: int) -> dict[str, object]:
    em = cfg.emulator
    return {
        "arch": arch,
