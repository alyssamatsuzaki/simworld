...
def node_feature_contract(cfg: SimWorldConfig) -> dict[str, NodeFeatureContract]:
...
def static_feature_shapes(cfg: SimWorldConfig) -> dict[str, tuple[int, int]]:
...
def static_node_features(
    cfg: SimWorldConfig, registry: pl.DataFrame, survey: pl.DataFrame
) -> dict[str, np.ndarray]:
