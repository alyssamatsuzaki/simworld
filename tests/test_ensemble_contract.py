...
from regworld.ensemble.validation import (
...
def _gating_cfg(smoke_cfg: RegWorldConfig) -> RegWorldConfig:
    cfg = smoke_cfg.model_copy(deep=True)
...
def test_enforce_coverage_gate_raises_below_threshold(smoke_cfg: RegWorldConfig) -> None:
    dev = _gating_cfg(smoke_cfg)
...
def test_smoke_degraded_paths_stay_ungated_and_write_a_report(smoke_cfg: RegWorldConfig) -> None:
