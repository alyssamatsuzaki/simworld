...
inside :func:`simworld.visualization.dashboard.load_default_config` via
...
All UI-building logic lives in :mod:`simworld.visualization.dashboard`; this
...
from simworld.visualization.dashboard import main
